...
(102, 'Tilastohevonen', 'til', 0, 0),
(103, 'Sleesianhevonen', 'slee', 0, 0),
(104, 'Shirenhevonen', 'shire', 4, 0),
(105, 'Nonius', 'non', 9, 0),
(106, 'Huzulponi', 'huzul', 0, 0),
...
(274, 'Albanianponi', 'alb', 0, 0),
(275, 'Puolalainen puoliverinen', 'pl', 0, 0),
(276, 'Kathiawarinhevonen', 'kath', 0, 0);

ALTER TABLE `vrlv3_lista_rodut` ADD  FOREIGN KEY (`roturyhma`) REFERENCES `vrlv3`.`vrlv3_lista_roturyhmat`(`id`) ON DELETE SET NULL ON UPDATE SET NULL;
