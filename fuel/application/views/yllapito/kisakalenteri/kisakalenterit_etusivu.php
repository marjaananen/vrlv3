...
foreach ($jaokset as $jaos){
  ...
  echo '<a href="'.site_url($url. 'kisahyvaksynta/'.$jaos['id']).'">Kutsujono</a>'; 

  echo "<p>".$jaos['hakemukset_norm']." kisa-anomusta ". latest('hakemukset_norm', $jaos)."<br />".
  //$jaos['hakemukset_porr']." porrastettua kisa-anomusta ". latest('hakemukset_porr', $jaos)."<br />".
      $jaos['tulokset_norm']." hakemusta tulosjonossa ". latest('tulokset_norm', $jaos)."<br />".
