...
<div class="panel-group">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">Kilpailun järjestäminen</div>
      <div class="panel-body">
        <b>Kilpailun ajankohta</b>
        <ul>
        ...
        <b>Kilpailujen järjestyspaikka</b>
        <ul>
        <li>Kilpailujärjestäjä voi järjestää useammat saman lajin kilpailut samana päivänä, kunhan talli on eri (uudet kilpailut samalle tallille voi anoa, kun edellisten tulokset on hyväksytty tulosarkistoon).</li>
        <li>Samalla tallilla pystyy järjestämään samana päivänä useammat saman lajin kisat, mikäli vastuuhenkilö on eri.</li>
        </ul>
    ...
    <div class="panel panel-info">
      ...
      <div class="panel-body">
        ...
        <p>Jaosten säännöt voivat sallia perinteisissä kilpailuissa näistä poikkeuksia. Porrastetuissa poikkeuksia ei tehdä.</p>
    ...
    <div class="panel panel-info">
      ...
      <div class="panel-body">
        ...
        <b>Arvontatavat</b>
        <ul>
            <li><b>Lyhyt arvonta</b>: Osallistujalista arvotaan kertaalleen jollain vapaavalintaisella arvontakoneella</li>
            <li><b>Pitkä arvonta</b>: Osallistujille arvotaan useita tuloksia (esim. osakokeet erikseen), joista yhteissumma ratkaisee. </li>
            <li><b>Suhteutettu arvonta</b>: Suhteutetussa arvonnassa arvontatulokseen vaikuttaa jokin hevosen keräämä ominaisuus, esim. aiempi sijoitusprosentti tms. Porrastetutkin ovat eräänlainen suhteutettu arvonta.</li>
            <li><b>Tuotosluokat</b>: Osallistujille jaetaan pisteitä jonkin tuotoksen, esim. tarinan, runon, piirroksen yms. tuotoksen mukaan.</li>
            <li><b>Kysymykset</b>: Osallistujat vastaavat kysymyksiin, ja tulos määräytyy niiden mukaan. Tasatuloksessa lopputulos usein arvotaan.</li>

        </ul>
        <b>Tulosten tuottaminen</b>
        <ul>
            <li>Tulokset tulee tuottaa täysin puolueettomasti!</li>
            <li>Tulosten muuntelu manuaalisesti on kiellettyä ja lasketaan vilpiksi. Mikäli kilpailujärjestäjä saa toistuvasti suurimman osan tai kaikki hevosistaan sijoittuneiden joukkoon, on aihetta epäillä vilpillistä toimintaa.</li>
            <li>Manuaalinen tulosten muuntelu on kiellettyä myös siinä tapauksessa, että kisanjärjestäjä haluaa huonontaa esimerkiksi omia sijoituksiaan.</li>
            <li>Arvontaluokkiin kilpailunjärjestäjä voi osallistua itse, mutta ei arvosteltaviin luokkiin (tarina, kysymykset jne..), ellei kilpailulle valita toista tuomaria.</li>
            <li>Luokka on järjestettävä, vaikka luokassa olisi vain yksi osallistuja.</li>
            <li>Kilpailijoiden poisjättäminen luokasta, johon he mahtuisivat ja ovat ajoissa (ja oikein) ilmoittautuneet, on vilpillistä toimintaa.</li>
        </ul>
        <b>Sijoittuneiden määrät/osallistujien määrät</b>
        <ul>
            <li>1-3 / 1</li>
            <li>4-8 / 2</li>
            <li>    9-15 / 3</li>
