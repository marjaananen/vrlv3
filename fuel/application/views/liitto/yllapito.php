...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    ...
    <p>Ylläpitäjinä toimivat <strong>Marsupieni VRL-01026</strong> ja <strong>Pipariina VRL-00050</strong></p>
  </div>
   <div class="panel-footer"><a href="mailto:yllapito(a)virtuaalihevoset.net">yllapito(a)virtuaalihevoset.net</a> </div>
</div>

<div class="panel panel-default">
  <div class="panel-heading">
    <h3 class="panel-title">Tekniikkavastaava</h3>
  </div>
  <div class="panel-body">
    <p>Tekniikkavastaava vastaa koodareiden ohjeistuksesta, ja uuden koodin tarkistamisesta ja testauttamisesta ennen julkaisua. Jos sinulla on kiinnostusta ja osaamista VRL:n kehittämiseksi (PHP, MySql), ota yhteyttä.</p>
    <p>Tekniiknisestä ylläpidosta ja suunnittelusta vastaa <strong>Hohtis VRL-14140</strong></p>
  </div>
  <div class="panel-footer"><a href="mailto:glowie(a)gmail.com">glowie(a)gmail.com</a> </div>
</div>
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    ...
    <p>Tunnusvastaavana toimii <strong>Scilla VRL-00091</strong></p>
  </div>
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    ...
    <p>Tunnusvastaavana toimii <strong>Troya VRL-03933</strong></p>
  </div>
  <div class="panel-footer"><a href="mailto:tyovoima(a)virtuaalihevoset.net">tyovoima(a)virtuaalihevoset.net</a> </div>
</div>
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    ...
    <p>Jaosvastaavana toimii <strong>Lumienkuli VRL-03491</strong></p>
  </div>
  <div class="panel-footer"><a href="mailto:jaokset(a)virtuaalihevoset.net">jaokset(a)virtuaalihevoset.net</a> </div>
</div>

<div class="panel panel-default">
  <div class="panel-heading">
    <h3 class="panel-title">Kantakirjavastaava</h3>
  </div>
  <div class="panel-body">
    <p>Kantakirjavastaava valvoo, että näyttelyjaos ja kaikki kantakirjat toimivat, ja noudattavat yhteisiä sääntöjä. Hän toimii yhteyshenkilönä kantakirjojen ja VRL:n ylläpidon välillä, rekrytoi tarpeen tullen uusia apukäsiä kantakirjojen tehtäviin, vie läpi sääntömuutokset, ja vastaa kantakirjojen ylläpitäjien kysymyksiin. </p>
    <p>Kantakirjavastaavan paikka on auki!</p>
  </div>
  <div class="panel-footer"><s><a href="mailto:kantakirjat(a)virtuaalihevoset.net">kantakirjat(a)virtuaalihevoset.net</a></s> </div>
</div>
