...
<div class="panel panel-default">
  ...
  <div class="panel-body">
   <p>Ylläpito vastaa VRL:n palvelimesta rahallisesti, ja tekee tekee päätökset uusien ominaisuuksien ohjelmoimisesta. Ylläpitoon otetaan myös yhteys esimerkiksi sponsori- ja mainosasioissa. Ylläpito myös vastaa suurista sääntömuutoksista, ja siitä, että osa-alueiden vastaavat hoitavat tehtävänsä. </p>    <p>Ylläpitäjinä toimivat: <br>
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
<p>Tunnusvastaava vastaa VRL-tunnusten hyväksynnästä, tuplatunnusten käsittelystä ja väärinkäyttötapauksissa tunnusten jäähylle asettamisesta sekä jäädyttämisestä. </p>    <p>Tunnusvastaavana toimii: <br>
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
<p>Työvoimavastaavan tehtäviin kuuluu uusien työntekijöiden rekrytointi ja valinta, osa-alueiden vastaavien rekrytointi ja valinta yhdessä ylläpidon kanssa, sekä rekistereiden ja rekisterityöntekijöiden valvonta kilpailujaoksia lukuun ottamatta. </p>    <p>Työvoimasvastaavana toimii<br>
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
<p>Jaosvastaava valvoo, että kaikki jaokset toimivat, ja noudattavat yhteisiä sääntöjä. Hän toimii yhteyshenkilönä jaosten ja VRL:n ylläpidon välillä, rekrytoi tarpeen tullen uusia apukäsiä jaosten tehtäviin, vie läpi sääntömuutokset, ja vastaa jaosten ylläpitäjien kysymyksiin. </p>    <p>Jaosvastaavana toimii <br>
...
<p>Ota yhteyttä rekisterityöntekijöihin<a href="<?php echo site_url();?>tuki">tuen</a>  kautta. </p>
   <table width="100%">
