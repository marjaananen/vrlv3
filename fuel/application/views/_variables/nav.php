...
$nav['jasenyys/jasenet'] = array('label' => 'Jäsenet', 'parent_id' => 'jasenyys', 'active' => 'jasenyys/jasenet'); //Koodattavaa: jäsenhaku, juuri nyt online, viimeisimmät rekisteröityneet
...
$nav['virtuaalitallit/rekisterointi'] = array('label' => 'Tallin rekisteröinti', 'parent_id' => 'virtuaalitallit', 'active' => 'virtuaalitallit/rekisterointi'); //Koodattavaa: rekisteröintilomake
$nav['virtuaalitallit/uusimmat'] = array('label' => 'Uusimmat tallit', 'parent_id' => 'virtuaalitallit', 'active' => 'virtuaalitallit/uusimmat'); //Koodattavaa: Uusimpien rekattujen tallien lista
$nav['virtuaalitallit/suosituimmat'] = array('label' => 'Suosituimmat tallit', 'parent_id' => 'virtuaalitallit', 'active' => 'virtuaalitallit/suosituimmat'); //Koodattavaa: TOP-listat
$nav['virtuaalitallit/paivitetyt'] = array('label' => 'Viimeksi päivitetyt tallit', 'parent_id' => 'virtuaalitallit', 'active' => 'virtuaalitallit/paivitetyt'); //Koodattavaa: Viimeksi päivitetyt tallit
